...
const UserDashboard = () => {
    ...
    const fetchTasks = async () => {
        ...
        try {
            ...
            const res = await axios.get(`https://multiclouddr.onrender.com/api/tasks/my-tasks/${userId}`);
            setTasks(res.data);
        } catch (err) {
    ...
    const fetchAllUsers = async () => {
        if (isAdmin && activeTab === 'users') {
            try {
                const res = await axios.get('https://multiclouddr.onrender.com/api/admin/users');
    ...
    const handleUpload = async (e) => {
        ...
        try {
            await axios.post('https://multiclouddr.onrender.com/api/tasks/add', formData);
            setShowModal(false);
            setTitle(''); 
            setDescription(''); 
            setFile(null);
    ...
    const executeDelete = async (platform) => {
        ...
        try {
            await axios.delete(`https://multiclouddr.onrender.com/api/tasks/${deleteId}?platform=${platform}`);
            setDeleteId(null); 
            fetchTasks(); 
        } catch (err) {
